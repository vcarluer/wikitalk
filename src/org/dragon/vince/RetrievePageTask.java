...
public class RetrievePageTask extends AsyncTask<String, Void, String> {
	...
	protected String doInBackground(String... params) {
    	...
    	HttpGet uri = new HttpGet("http://" + this.mainActivity.getCountryLc() + ".wikipedia.org/w/api.php?format=xml&action=query&titles=" + search + "&prop=revisions&rvprop=content");
